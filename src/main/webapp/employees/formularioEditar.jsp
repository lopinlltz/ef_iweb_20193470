...
<jsp:useBean id="empleado" type="com.example.webapphr3.Beans.Employee" scope="request"/>
                    ...
                    <form method="POST" action="EmployeeServlet">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="manager_id" id="manager_id" class="form-select form-select-sm">
                                <option value="sin-jefe" <%= empleado.getManager() == null ? "selected" : "" %>>
                                    --Sin jefe--
                                </option>
                                <% for (Employee employee : listaJefes) {%>
                                <option value="<%=employee.getEmployeeId()%>" <%= empleado.getManager() == null ? "" : empleado.getManager().getEmployeeId() == employee.getEmployeeId() ? "selected" : "" %>>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="department_id" id="department_id" class="form-select form-select-sm">
                                <option value="sin-depa" <%= empleado.getDepartment() == null ? "selected" : "" %>>
                                    --Sin depa--
                                </option>
                                <% for (Department department : listaDepartamentos) {%>
                                <option value="<%=department.getDepartmentId()%>" <%=empleado.getDepartment() == null ? "" : empleado.getDepartment().getDepartmentId() == department.getDepartmentId() ? "selected" : "" %>>
